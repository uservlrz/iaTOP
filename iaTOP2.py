...
def pagina_principal():
    ...
    acao = st.radio("Escolha uma ação:", ("Enviar mensagem", "Gerar imagem"))
    prompt = st.text_input('Fale com o chat ou digite um prompt para imagem', '')
        ...
        if acao == "Enviar mensagem":
            ...
            if prompt:
                ...
                if url_imagem.startswith("http"):
                    st.image(url_imagem, caption='Imagem gerada com base no seu prompt')
                else:
                    st.error(url_imagem)
